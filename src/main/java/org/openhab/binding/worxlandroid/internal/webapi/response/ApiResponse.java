...
public interface ApiResponse {
    ...
    // MemberNames
    public static final String MN_UPDATEDAT = "updated_at";
    public static final String MN_CREATEDAT = "created_at";
    public static final String MN_ACTIONSONGOOGLEPINCODE = "actions_on_google_pin_code";
    ...
    public static final String MN_SURNAME = "surname";
    public static final String MN_NAME = "name";
    public static final String MN_EMAIL = "email";
    public static final String MN_ID = "id";
